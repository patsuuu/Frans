...
<a href="indexx.php" class="btn btn-success"></i> Back</a>
<body>

	<div class="container">
<a href="https://lexacademy.in" target="_blank"><img src="" ></a><br><hr>
...
?>
  ...
  <i class="fa fa-plus"></i> Add New Inforamation
  </button>
...
<div class="form-group col-md-6">
<label for="aadharno">Tel no.</label>
<input type="text" class="form-control" name="user_aadhar" maxlength="7" placeholder="Enter 7-digit Postal code ">
</div>
</div>
...
<div class="form-group">
<label for="inputAddress2">Police Station No.</label>
<input type="number" class="form-control" name="police_station" placeholder="Enter police station no.">
</div>

<div class="form-group">
<label for="inputAddress">State</Address></label>
...
<select name="state" class="form-control">
  <option selected>Choose...</option>
  <option value="Villa Apollonia"> Villa Apollonia</option>
									<option value="Munting Mapino">Munting Mapino</option>
									<option value="Timala Conception">Timala Conception</option>
									<option value="Timalan Balsahan">Timalan Balsahan</option>
									<option value="Hillsview">Hillsview</option>
									<option value="Ciudad Nuevo">Ciudad Nuevo</option>
									...
									<option value="Mabulo">Mabulo</option>
									<option value="Maquina">Maquina</option>
									<option value="Molino">Molino</option>
									<option value="Sapa">Sapa</option>
									<option value="Humbac">Humbac</option>
									<option value="Capt. C. Nazareno (Pob.)x		">Capt. C. Nazareno (Pob.)</option>
</select>
</div>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<strong>Tel No. :</strong> $aadhar <br>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group'>
		<label for='inputAddress2'>Police Station No.</label>
		<input type='number' class='form-control' name='police_station' placeholder='Enter police station no.' value='$police'>
		</div>
		...
		<select name='state' class='form-control'>
		  ...
		  <option value='Villa Apollonia'>Villa Apollonia</option>
									...
									<option value='Sapa'>Sapa</option>
									<option value='Humbac'>Humbac</option>
									<option value='Capt. C. Nazareno (Pob.)'>Capt. C. Nazareno (Pob.)</option>
